...
-(BOOL) parseSheetXML:(NSString *)_xmlfile toCharacter:(FTCCharacter *)_character
{
    ...
    do {
        ...
        if (textureSheetExists)
            _sprite = [[FTCSprite alloc]initWithSpriteFrameName:nImage];//[FTCSprite spriteWithSpriteFrameName:nImage];
        else 
            _sprite = [[FTCSprite alloc]initWithFile:nImage];//[FTCSprite spriteWithFile:nImage];
